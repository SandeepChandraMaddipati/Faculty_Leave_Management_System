			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600"><h5>Om Amriteswaryai Namah</h5><br>
<h6>“The basic problem is the confusion over what is permanent and what is impermanent”</h6><br>

<h5>Chancellor,</h5>
<h5>Sri Mata Amritanandamayi Devi</h5></p>
					</div>
				</div>
			</div>
