		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext"> My Leave </span>
						</a>
						<ul class="submenu">
					...
					<li>
						<a href="https://intranet.cb.amrita.edu/academics/calendar" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-edit-2"></span><span class="mtext">Academic Calendar</span>
						</a>
					</li>
					<li>
						<a href="https://intranet.cb.amrita.edu/TimeTable/Faculty/index.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-edit-2"></span><span class="mtext">Faculty Time Table</span>
						</a>
					</li>
				</ul>
			</div>
